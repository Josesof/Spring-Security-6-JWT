...
@Configuration
//Le indica al contenedor de spring que esta en una clase  de seguridad al momento de arrancar la aplicacion
@EnableWebSecurity
//Indicamos que se activa la seguridad web en nuestra alicacion y ademas esta sera una clase que contiene todo lo referente a seguridad
